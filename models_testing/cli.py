...
def main():
    ...
    parser.add_argument('--input-dir', default=processed_audio_path,
    ...
    print(f"Evaluating models: {', '.join(selected_models.keys())}")
    
    evaluator = ModelEvaluator(selected_models, output_dir)
